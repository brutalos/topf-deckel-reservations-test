    ...
    <main className="min-h-screen pt-24 bg-background font-body pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-sans font-extrabold text-foreground mb-8 leading-tight">
            Wofür wir stehen – und warum wir’s tun.
          </h1>
          <p className="text-xl font-sans font-bold text-primary mb-4">Vom ersten Topf bis heute.</p>
          <p className="text-lg text-muted-foreground mb-8">Das war von Anfang an unser Versprechen.</p>
          ...
          <p className="text-xl font-bold mt-8">Wir wollten zeigen: Es geht besser.</p>
        </div>
